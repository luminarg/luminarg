        ...
        <div className="mx-auto max-w-6xl space-y-10">
          ...
          {!sales || sales.length === 0 ? (
            <div className="border border-white/10 bg-white/[0.03] p-8">
              <p className="text-neutral-400">Todavía no tenés compras.</p>

              <Link
                href="/products"
                className="mt-6 inline-block rounded-full bg-white px-5 py-3 text-sm font-medium text-black"
              >
                Ver catálogo
              </Link>
            </div>
                    ...
                    <div>
                      ...
                      <div className="mt-5 grid gap-2 text-sm text-neutral-400 sm:grid-cols-2">
                        ...
                        <p>
                          Total:{" "}
                          <span className="text-white">
                            ARS {money(Number(sale.total_amount || 0))}
                          </span>
                        </p>
                        ...
                        <p>
                          Transporte:{" "}
                          <span className="text-white">
                            {sale.shipping_carrier || "Pendiente"}
                          </span>
                        </p>
                        ...
                        <p>
                          Seguimiento:{" "}
                          <span className="text-white">
                            {sale.shipping_tracking_id || "Pendiente"}
                          </span>
                        </p>
                      </div>
                      ...
                      {sale.shipping_tracking_url && (
                        <a
                          ...
                          target="_blank"
                          className="mt-4 inline-block text-sm text-[#d6b36a]"
                        >
                          Ver seguimiento
                        </a>
                      )}
